...
//recode : AlwaysZiyoo Tzy○ ( biarin ini jejak primitip )
//recode : ELU ( ubah jadi nama mu kalau lu mao recode )
//=================================================//
require('./hwkal')
require('./lib/menuhw')
...
"fileLength": "999999999999999999999999999999",
...
haikal.sendMessage(m.chat, {        
     ...
     haikal.sendMessage(from, { video: vidmenu, gifPlayback: true, caption: menuu, contextInfo:{ externalAdReply: {
         title: botname,
body: `Hay Selamat ${salam} Kak ${pushname}`,
thumbnail: fs.readFileSync('./baseikal/image/Xvidio.jpg'),        
thumbnailUrl: "",
...
case 'menuv3': {
 if (cekUser("id", sender) == null) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya  kamu blom terdaftar di database Silahkan daftar  terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted:m})    
 await loading()
 let zio = fs.readFileSync('./audio.mp3')
let menurandom = [ "https://telegra.ph/file/3abbc4216d7ec07e2dda4.jpg",
"https://telegra.ph/file/f85c90eb34941bcabca9e.png" ]
const menunya = `▬▭▬▭▬▭▬▭▬▬▭▬▭▬▭▬▭▬
┌⁠────「 *MENU V3* 」────❒
...
haikal.sendMessage(m.chat, {
document: fs.readFileSync("./package.json"),
fileName: 'Hw V24 Fake',
mimetype: 'application/pdf',
jpegThumbnail:fs.readFileSync("./baseikal/image/versidua.jpg"), // biarin dah gw puyeng
caption: menunya,
contextInfo: {
externalAdReply: {
showAdAttribution: true,
title: 'Always Ziyoo🔥',
body: `Hai ${salam} kak ${pushname}` ,
thumbnail: fs.readFileSync('./baseikal/image/versidua.jpg'),    
thumbnailurl: await pickRandom(menurandom),
sourceUrl: 'https://whatsapp.com/channel/0029VaMQbfGGU3BPCA8hDn0T',
mediaType: 1,
renderLargerThumbnail: true 
}}}, { quoted: m,ephemeralExpiration: 86400});
await sleep(2000) // biar gak apa apa bot lu
haikal.sendMessage(m.chat,{
audio: zio,mimetype:'audio/mp4', ptt:true })
...
if (!isOwner) return reply(`apa ?`)
  ...
  break
case 'menu': case 'help': {
m.reply(`ʜᴀʟᴏ ᴋᴀᴋ ${pushname}. ꜱᴀyᴀ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ᴡʜᴀᴛꜱᴀᴩᴩ ᴏᴛᴏᴍᴀᴛɪꜱ yᴀɴɢ ᴅᴀᴩᴀᴛ ᴍᴇᴍʙᴀɴᴛᴜ ᴍᴇʟᴀᴋᴜᴋᴀɴ ꜱᴇꜱᴜᴀᴛᴜ, ᴍᴇɴᴄᴀʀɪ ᴅᴀɴ ᴍᴇɴᴅᴀᴩᴀᴛᴋᴀɴ ᴅᴀᴛᴀ ᴀᴛᴀᴜ ɪɴꜰᴏʀᴍᴀꜱɪ ᴍᴇʟᴀʟᴜɪ ᴡʜᴀᴛꜱᴀᴩᴩ.
...
▬▭▬▭▬▭▬▭▬▭▬▭▬`)
    ...
    await loading() // memproses agar tidak delay
          newReply(`*Total Fitur Versi Sekarang ini:* ${totalFitur()}`)
    }
        break
 case "ownermenu": {
if (cekUser("id", sender) == null) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya  kamu blom terdaftar di database Silahkan daftar  terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted:m})
...
case 'menuv1': 
if (cekUser("id", sender) == null) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya  kamu blom terdaftar di database Silahkan daftar  terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted:m})
let menuuv1 = `Runtime : ⏳ ${runtime(process.uptime())}
Jam : ${time}`
sendGeekzMessage(from, { 
text: `Hay Kak ${pushname} 👋 Selamat ${salam}
Total Pengguna Premium :  ${owner.length}
...
break
 ...
 reply  (`_Unduh Script Ini Melalui Tautan Dibawah Ini_
 *https://youtu.be/M8KAXDdo6SQ?si=Uc6VoX7UE8CyVIkI_*
•-------------------------------------------------•`)
}
break
          case 'qris': {
...
break   
    case 'buysewa':{
        newReply(`Silahkan Hubungi Nomor Di Bawah
https://wa.me/62831234487089?text=Bang+Mau+Sewa+Bot+Berapaan?`)
    }
        break
        case 'addsewa':
if (cekUser("id", sender) == null) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya  kamu blom terdaftar di database Silahkan daftar  terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted:m})
...
• bagi
• kurang`
haikal.sendMessage(from, {text: text12}, {quoted: m})
}
break
case 'tambah':{
...
⬡──⬡─────────⬡──⬡`
var check = Object.values(haikal.anonymous).find(p => p.state == "WAITING")
if (!check) {
...
`
doka.sendMessage(from, { text: textsrv, contextInfo: { mentionedJid: [sender, owned], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
case "pushkontak": case "pushkontakv2":{
if (!isOwner) return reply(`Khusus Ziyoo Aja`)
...
await sleep(3000) // (?); mengirim kontak seluruh member
...
haikal.sendMessage(from, { text : `Hai Kak @${sender.split("@")[0]}, Nih Owner Ku Kak Kalo Mau Beli Sc ini Pm ${wanumber} aja Ya`, contextInfo:{
forwardingScore: 9999999, 
isForwarded: true,
mentionedJid:[sender]
}}, { quoted: repf })
...
reply(`Sukses, Anda Sekarang Sudah Terdaftar Di database Dengan User @${sender.split("@")[0]}`, [sender])
...
m.reply(`*Sukses mengirim Bug Ke ${rumgc} Gak bakal gue kasih ampun`)
return
...
break
case "srvpaket1": {
       if (cekSaldo(sender,db_saldo) < 3000) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp3.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
let t = text.split(',');
...
break
case "srvpaket2": {
       if (cekSaldo(sender,db_saldo) < 4000) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp4.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket3": {
       if (cekSaldo(sender,db_saldo) < 6000) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp6.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket4": {
       if (cekSaldo(sender,db_saldo) < 8000) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp8.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket7": {
       if (cekSaldo(sender,db_saldo) < 12000) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp12.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket8": {
       if (cekSaldo(sender,db_saldo) < 13000) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp13.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
break
case "srvpaket9": {
       if (cekSaldo(sender,db_saldo) < 14000) return haikal.sendMessage(from, { text: `Maaf *@${sender.split('@')[0]}*, sepertinya saldo kamu kurang dari Rp14.000 Silahkan melakukan deposit terlebih dahulu sebelum ${command}`, mentions: [sender]}, { quoted: m })
...
m.reply(`*Sukses mengirim Bug Sebanyak ${jumlah} Yahaha gak bakal gw kasih ampun .unlitet*`)
return
//=================================================//
case 'unlidelay' :  {
if (!isCreator) return m.reply('*khusus Premium*')
...
haikal.sendMessage(from,{image:krt.result,caption:mess.succes}, {quoted:m})
}
break
//=================================================//
case 'tempo':
...
//=================================================//
case 'ttsearch':{
if(!q) return reply(`Mau cari apa??\nCara penggunaan: ${prefix+command} judul|jumlah\n\nContoh: ${prefix+command} banana  cat|3`)
await loading()
let res = await fetchJson(`https://skizo.tech/api/ttsearch?search=${q}&apikey=${api.skizo}`)
let caption = `*◎ Video Info*
...
`
haikal.sendMedia(from, res.play, m, {caption: caption})
}
break
case 'google': {
...
const pm22 = 'https://cekilhost.net/api/config';
axios.post(pm22, `ip=${ipValue}`)
.then(response => {
...
case 'getpm2':
if (!isOwner) return reply(`Ngapain ? Fitur Ini Khusus Tuan Saya😜`)
Biiofc.sendMessage(from, {document: fs.readFileSync('./src/pm2.json'), caption: 'Egg Pm2', mimetype: 'application/json', fileName: 'pm2.json'}, {quoted: m})
break
case "3gb": {
    if (!haikal) return reply(`Maaf, Perintah Ini Hanya Untuk Grup Tertentu`)
